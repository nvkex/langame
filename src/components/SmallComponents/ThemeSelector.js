        ...
        <ThemeTab onClick={() => props.setDarkMode(d => !d)}>
            {
                props.dark ? (
                    <span>
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="bi bi-brightness-high-fill" viewBox="0 0 16 16">
