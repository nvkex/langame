...
const ThemeSelector = (props) => {
    ...
    const classes = useStyles({ theme : theme ? themeConfig.dark : themeConfig.light });
    return (
        <div className={classes.themeTab} onClick={() => props.setDarkMode(d => !d)}>
            {
                props.dark ? (
                    <span>
                    ...
                    <span>
                        ...
                        <span className={classes.text}>Night</span>
                    </span>
                )
            }
        </div>
